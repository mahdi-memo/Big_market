...
import 'package:me/src/enums/auth_mode.dart';
import 'package:me/src/model/user_info_model.dart';
import 'package:me/src/model/user_model.dart';
  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http
          .get("https://food-3371d-default-rtdb.firebaseio.com/users.json");
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          "https://food-3371d-default-rtdb.firebaseio.com/users.json",
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDRuCa3oq06JvWRz4BDt-3G6isVZ2FFMX8",
        ...
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDRuCa3oq06JvWRz4BDt-3G6isVZ2FFMX8",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
